...
```
WattPredictor/
Γö£ΓöÇΓöÇ config_file/         # YAML config, schema, hyperparams
Γö£ΓöÇΓöÇ notebooks/           # EDA, training notebooks
Γö£ΓöÇΓöÇ src/WattPredictor/   # Main ML pipeline logic
Γöé   Γö£ΓöÇΓöÇ components/      # ingestion, validation, transformation, etc.
Γöé   Γö£ΓöÇΓöÇ pipeline/        # Orchestrated pipelines
Γöé   Γö£ΓöÇΓöÇ config/          # Configuration managers
Γöé   Γö£ΓöÇΓöÇ entity/          # Data classes (pydantic/dataclass)
Γöé   Γö£ΓöÇΓöÇ utils/           # Helpers, logger, exceptions
Γö£ΓöÇΓöÇ app.py               # Streamlit visualization
Γö£ΓöÇΓöÇ main.py              # CLI interface for DVC stages
Γö£ΓöÇΓöÇ Dockerfile           # Container config
Γö£ΓöÇΓöÇ dvc.yaml             # ML pipeline orchestration
ΓööΓöÇΓöÇ .github/workflows/   # CI/CD via GitHub Actions
```
